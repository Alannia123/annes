...

{
    ...
    'depends': ['web','website','portal', 'account', 'mis_website', 'mis_education_erp_dashboard',
                'mis_homework', 'mis_school_calender'],
    'data': [
    ...
    'assets': {
        'web.assets_frontend': [
            ...
            # '/mis_student_portal/static/src/js/portal_tts.js',
